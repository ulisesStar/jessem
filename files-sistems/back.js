...
var modelos = [
    {   nombre : 'Trabajador',    singular : 'trabajador',      plural : 'trabajadores'},
    {   nombre : 'Imagenes',    singular : 'imagen',      plural : 'imagenes'},
    {   nombre : 'Subservicios',    singular : 'subservicio',      plural : 'subservicios'},
    {   nombre : 'Servicios',    singular : 'servicio',      plural : 'servicios'},
    {   nombre : 'Proyectos',    singular : 'proyecto',      plural : 'proyectos'}
]
